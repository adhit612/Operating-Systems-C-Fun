...
* shell command to compile: gcc bitops.c -o bitops -lm
* shell command to run: ./bitops
*/
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
{
    //https://stackoverflow.com/questions/61710373/how-can-you-change-a-single-bit-of-a-bitmap-inside-a-char-array-in-c
    //Implement your code here
...
static int get_bit_at_index(char *bitmap, int index)
{
    ...
    return (bitmap[byte_index] & (1 << bit_index)) >> bit_index;
}
